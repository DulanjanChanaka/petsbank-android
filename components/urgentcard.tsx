  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.cardContainer}>
        {userPosts.map((item) => {
          // Check if the type of the post is "urgent"
          if (item.type === 'urgent') {
            return (
              <TouchableOpacity
                key={item.id}
          ...
          // If the type is not "urgent," return null (which won't render anything)
          return null;
        })}
      </View>
          ...
          <View style={styles.modalContent}>
            ...
            {selectedPost?.imagelink && (
              <Image source={{ uri: selectedPost?.imagelink }} style={styles.modalImage} />
                        ...
                        <Text style={styles.modalDescription}>Poster Name :  {selectedPost?.name}</Text>
